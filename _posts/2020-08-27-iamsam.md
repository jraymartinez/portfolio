...
!['Algorithm 1']({{ site.url }}{{ site.baseurl }}/assets/images/iamsam_algo.png){:style="float: right;margin-right: 7px;margin-top: 7px;"} 
...
## IMPLEMENTED SYSTEM
In this section, we presented the overall architecture to implement the system and discussed the major system features. The I AM SAM web app can be visited [here](https://summarizer-appl.herokuapp.com/).
...
[6] <a id="ref6"></a> Benjamin Van Durme Courtney Napoles and ChrisCallison-Burch. 2011. Evaluating sentence com-pression: Pitfalls and suggested
