...
## IMPLEMENTED SYSTEM
In this section, we present the overall architecture to implement the proposed
system, and discussed the major system features. The URL can be visited [here](https://summarizer-appl.herokuapp.com/).
