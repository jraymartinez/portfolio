...
evaluation and take output length into account [[7](#ref7)]. For each
...
We compare the performance of the three different summarizing techniques with each other. [[Table 1](#table1)] shows the results
