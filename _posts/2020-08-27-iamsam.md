...
### METHODOLOGY
We applied the three sumy methods in the sampled business news
articles. All these algorithms extract six sentences from each
article in order to compose the summary. We performed an experimental comparison with three extractive summarization
techniques.
...
[12]. Concretely, Rouge-N with unigrams and bigrams (Rouge1 and Rouge-2) and Rouge-L. Each Rouge has corresponding
...
!['Algorithm 1']({{ site.url }}{{ site.baseurl }}/assets/images/iamsam_algo.png) 
